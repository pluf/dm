<?php
Pluf::loadFunction('DM_Shortcuts_GetPlanTemplateOr404');

class DM_Views_PlanTemplate
{

    public static function create($request, $match)
    {
        // Create plan template and get its ID
        $form = new DM_Form_PlanTemplateCreate($request->REQUEST, array());
    ...
    {
        $plantemplate = new Pluf_Paginator(new DM_Asset());
    ...
    {
        // تعیین داده‌ها
        $plantemplate = DM_Shortcuts_GetPlanTemplateOr404($match["id"]);
        // حق دسترسی
    ...
    public static function update($request, $match)
    {
        ...
        $form = new DM_Form_PlanTemplateUpdate(array_merge($request->REQUEST), $extra);
