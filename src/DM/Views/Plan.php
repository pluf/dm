<?php
Pluf::loadFunction('DM_Shortcuts_GetPlanOr404');
...
class DM_Views_Plan
{
    ...
    public static function create($request, $match)
    {
        ...
        $form = new DM_Form_PlanCreate($request->REQUEST, $extra);
        $plan = $form->save();
    ...
    {
        $plan = new Pluf_Paginator(new DM_Plan());
    ...
    {
        // تعیین داده‌ها
        $plan = DM_Shortcuts_GetPlanOr404($match["id"]);
        // حق دسترسی
    ...
    public static function update($request, $match)
    {
        ...
        $form = new DM_Form_PlanUpdate(array_merge($request->REQUEST), $extra);
        $plan = $form->update();
        return new Pluf_HTTP_Response_Json($plan);
    }
    ...
    {
        $plan = DM_Shortcuts_GetPlanOr404($match['planId']);
